...
## Project Structure
    ...
    ├── deployementissue_de_27204  # Django project configurations
...
1. Clone this repo and `cd deployementissue_de_27204`
...
2. Clone this repo and `cd deployementissue_de_27204`
